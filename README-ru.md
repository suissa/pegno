...
<p align="center">
  <h1 align="center">Что такое <br /><img src="https://i.imgur.com/P1VL4bC.png" height="80" alt="p3g logo"/><br />?</h1>
</p>

**p3g** — это менеджер зависимостей с **глобальным кэшем**, **авто-линковкой**, **мини-воркспейсами** и **режимом мгновенной синхронизации**, созданный на 100% на **Bun + TypeScript**.
...
**p3g** решает это, создавая **глобальное рабочее пространство** в вашей системе, где зависимости устанавливаются один раз и переиспользуются через _симлинки_ (или копии, если предпочитаете).
...
Использование:
  p3g axios@latest   → Устанавливает пакет напрямую
  p3g use api        → Использует сохраненный мини-воркспейс
  p3g list           → Список мини-воркспейсов
  p3g --dev          → Устанавливает как devDependency
  p3g --copy         → Копирует вместо линковки
  p3g sync           → Копирует весь глобальный воркспейс
  p3g --verbose      → Подробные логи
```
...
Создатель экосистемы **Full Agentic Stack**, **Atomic Behavior Types**, а теперь… **p3g**.

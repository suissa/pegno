...
**Pegno** แก้ปัญหานี้โดยสร้าง **workspace แบบ global** ในระบบของคุณ ที่ dependency จะถูกติดตั้งครั้งเดียวและใช้ซ้ำผ่าน _symbolic links_ (หรือ copies หากคุณต้องการ)
